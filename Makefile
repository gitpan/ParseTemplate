# This Makefile is for the Parse::Template extension to perl.
#
...
#	DISTNAME => q[ParseTemplate]
#	NAME => q[Parse::Template]
#	VERSION_FROM => q[lib/Parse/Template.pm]
#	clean => { FILES=>q[err] }
...
H_FILES = 
MAN1PODS = 
MAN3PODS = lib/Parse/Template.pm
...
TO_INST_PM = lib/Parse/Template.pm

PM_TO_BLIB = lib/Parse/Template.pm \
...
$(INST_MAN3DIR)/.exists :: /usr/local/lib/perl5/5.00502/sun4-solaris/CORE/perl.h
	@$(MKPATH) $(INST_MAN3DIR)
	@$(EQUALIZE_TIMESTAMP) /usr/local/lib/perl5/5.00502/sun4-solaris/CORE/perl.h $(INST_MAN3DIR)/.exists
...
manifypods : pure_all lib/Parse/Template.pm
	@$(POD2MAN) \
	lib/Parse/Template.pm \
	$(INST_MAN3DIR)/Parse::Template.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIB)/Parse/Template.pm
...
Makefile : Makefile.PL $(CONFIGDEP)
	...
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" Makefile.PL "PREFIX=~"
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"ParseTemplate\" VERSION=\"0,31,0,0\">\n}. qq{\t<TITLE>ParseTemplate</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > ParseTemplate.ppd
